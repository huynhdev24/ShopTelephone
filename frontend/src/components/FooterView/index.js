      ...
      <div className="container p-tb-32">
        <p className="t-center" style={{ color: '#888' }}>
          <span className="font-size-18px">
            CÔNG TY CỔ PHẦN THƯƠNG MẠI - DỊCH VỤ SHOP TELEPHONE
          </span>
          <br />
          <strong>Trụ sở:</strong>&nbsp;Số 1 Đại Cồ Việt, Hai Bà Trưng, Hà Nội
          <br />
          <strong>Văn phòng:</strong>&nbsp; Toà nhà B1, Số 1 Đại Cồ Việt, Hai Bà Trưng, Hà Nội
          <br />
          <strong>Điện&nbsp;thoại:</strong>&nbsp;0354.135.378 |{' '}
          <strong>Email:</strong>&nbsp;bk-support@gmail.com&nbsp;|{' '}
          <strong>Website:</strong>&nbsp;<a href="/">soict.hust.edu.vn</a>
        </p>
        <div className="d-flex align-i-center justify-content-center">
          ...
          <div className="d-flex align-i-center m-lr-32">
            ...
            <div className="t-center m-l-16">
              ...
              <h2 style={{ color: '#CE1F26' }}>0354.135.378</h2>
            </div>
          </div>
